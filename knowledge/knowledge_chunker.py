...
def build_knowledge_chunks(documents):
    ...
    for doc in documents:
        ...
        for s_idx, section in enumerate(sections):
            parent_chunk_size = CHUNK_PARENT_LARGE_SIZE if len(section) > CHUNK_PARENT_LARGE_THRESHOLD else CHUNK_PARENT_DEFAULT_SIZE
            ...
            for p_idx, parent_content in enumerate(parent_chunks):
                ...
                child_chunk_size = CHUNK_CHILD_NUMERIC_SIZE if len(re.findall(r"\d", parent_content)) > CHUNK_CHILD_NUMERIC_THRESHOLD else CHUNK_CHILD_DEFAULT_SIZE
