...
class KeywordReranker(BaseReranker):
    ...
    def __init__(self):
        # Initialize jieba
        # jieba.initialize() # Usually lazy loaded
        pass
    ...
    def rerank(self, query: str, candidates: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        ...
        # Add keyword score to candidates
        for cand in candidates:
            content = cand.get("content", "")
            content_lower = content.lower()
            
            # Simple term frequency sum
            # For short chunks, raw count is okay.
            # For longer chunks, maybe normalize by length?
            # Let's keep it simple: raw count.
            count = 0
        ...
        # Sort by keyword_score DESC, then by original distance ASC (assuming distance is small=better)
        # Note: In Chroma, distance is usually L2 or Cosine distance (small is better).
        # We want high keyword score, low distance.
...
class ModelReranker(BaseReranker):
    ...
    def rerank(self, query: str, candidates: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        ...
        # Sort by model_score DESC (higher is better for CrossEncoder)
